...
import com.afrikatek.store.domain.ProductCategory;
import com.afrikatek.store.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link com.afrikatek.store.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
