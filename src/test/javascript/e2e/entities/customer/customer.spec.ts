...
describe('Customer e2e test', () => {
  ...
  it('should create and save Customers', async () => {
    ...
    expect(await customerUpdatePage.getAddressLineOneInput()).to.eq(
      'addressLineOne',
      'Expected AddressLineOne value to be equals to addressLineOne'
    );
    expect(await customerUpdatePage.getAddressLineTwoInput()).to.eq(
      'addressLineTwo',
      'Expected AddressLineTwo value to be equals to addressLineTwo'
    );
