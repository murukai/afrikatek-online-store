...
export class CustomerUpdatePage {
  ...
  addressLineOneInput = element(by.id('field_addressLineOne'));
  addressLineTwoInput = element(by.id('field_addressLineTwo'));
  ...
  async setAddressLineOneInput(addressLineOne: string): Promise<void> {
    await this.addressLineOneInput.sendKeys(addressLineOne);
  }

  async getAddressLineOneInput(): Promise<string> {
    return await this.addressLineOneInput.getAttribute('value');
  }

  async setAddressLineTwoInput(addressLineTwo: string): Promise<void> {
    await this.addressLineTwoInput.sendKeys(addressLineTwo);
  }

  async getAddressLineTwoInput(): Promise<string> {
    return await this.addressLineTwoInput.getAttribute('value');
  }
