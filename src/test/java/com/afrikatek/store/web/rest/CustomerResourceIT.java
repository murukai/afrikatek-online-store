...
import com.afrikatek.store.domain.Customer;
import com.afrikatek.store.domain.User;
import com.afrikatek.store.repository.CustomerRepository;
import com.afrikatek.store.service.CustomerService;
...
import com.afrikatek.store.domain.enumeration.Gender;
/**
...
public class CustomerResourceIT {
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAddressLineOne()).isEqualTo(DEFAULT_ADDRESS_LINE_ONE);
        assertThat(testCustomer.getAddressLineTwo()).isEqualTo(DEFAULT_ADDRESS_LINE_TWO);
    ...
    public void checkAddressLineOneIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setAddressLineOne(null);
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAddressLineOne()).isEqualTo(UPDATED_ADDRESS_LINE_ONE);
        assertThat(testCustomer.getAddressLineTwo()).isEqualTo(UPDATED_ADDRESS_LINE_TWO);
